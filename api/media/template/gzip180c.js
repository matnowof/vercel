...
function cp_exp(val){if(jQuery('#formula').val()!='')jQuery('#formula').val(jQuery('#formula').val()+' '+val);else jQuery('#formula').val(val);jQuery('#formula').focus();}
...
var len = $("#formula").val().length;

 var valor = $("#formula").val();
